...
add_action( 'after_setup_theme', 'tribund_theme_setup', 5 );
 ...
 * @return void
 */
function tribund_theme_setup() {

	// Theme layouts.
	add_theme_support( 'theme-layouts', array( 'default' => '1c', 'customize' => false, 'post_meta' => false ) );
